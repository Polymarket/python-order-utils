...
class Erc1155Facade(BaseFacade):
    ...
    def transfer_from(
        self, from_address, to_address, token_address: str, token_id: str, value: str
    ):
        """
    ...
    def balance_of(self, address: str, token_id: str):
        ...
        """
        return self._get_contract("erc1155").encodeABI(
            fn_name=self.balanceOf, args=[normalize_address(address), token_id]
        )
