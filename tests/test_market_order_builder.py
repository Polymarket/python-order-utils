...
class TestMarketOrderBuilder(TestCase):
    def test_validate_inputs(self):
        builder = MarketOrderBuilder(
            "0xCf7Ed3AccA5a467e9e704C703E8D87F634fB0Fc9", 31337, mock.MagicMock()
        )
    ...
    def test_build_market_order(self):
        ...
        self.assertEqual(
            "0xe3d9BFA896aF6988f80027bfd13440A42C5ed02b", mkt_order["maker"]
        )
        self.assertEqual(
            "0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512", mkt_order["makerAsset"]
        )
        self.assertEqual(1000000, mkt_order["makerAmount"])
        self.assertEqual(0, mkt_order["makerAssetID"])

        self.assertEqual(
            "0x5FbDB2315678afecb367f032d93F642f64180aa3", mkt_order["takerAsset"]
        )
        self.assertEqual(1, mkt_order["takerAssetID"])

        self.assertEqual(
            "0xe3d9BFA896aF6988f80027bfd13440A42C5ed02b", mkt_order["signer"]
        )
    ...
    def test_build_market_order_signature(self):
        ...
        builder = MarketOrderBuilder(
            "0x0165878A594ca255338adfa4d48449f69242Eb8F", 31337, signer
        )
        expected_struct_hash = (
            "0x6b5da848321b92bc4c7d045289484063e6e31aa3197bd2ccecad302f6b043b47"
        )

        mkt_order = builder.build_market_order(mkt_order_data)
        self.assertEqual(
            expected_struct_hash, builder._create_struct_hash(mkt_order).hex()
        )
